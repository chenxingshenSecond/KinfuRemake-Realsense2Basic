...
//        //asm("st.global.cs.v2.u16 {%0, %1}, [%2];" : "=h"(reinterpret_cast<ushort&>(cx)), "=h"(reinterpret_cast<ushort&>(cy)) : _ASM_PTR_(ptr));
//        asm("st.global.cs.v2.u16  {%0, %1};" :  "=h"(reinterpret_cast<ushort&>(cx)), "=h"(reinterpret_cast<ushort&>(cy)));
